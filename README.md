...
<body style="background-color: rgb(206, 235, 23);">
        <h1 align="center" style="color: rgb(24, 47, 222);">JANANI S 23013409</h1>
...
![Alt text](<Janani/calcapp/static/Screenshot (70).png>)
![Alt text](<Janani/calcapp/static/Screenshot (71).png>)
